...
public class TicketService extends Service {
    ...
    public static void addTicket(Ticket ticket) { ticketDao.addTicket(ticket); }

    public static ArrayList<Ticket> getTicketsByUser(User user) { return ticketDao.getTicketsByUser(user); }
